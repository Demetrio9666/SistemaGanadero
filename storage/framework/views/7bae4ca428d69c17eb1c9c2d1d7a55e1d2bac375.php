...
<head>
    ...
    <?php $__env->startSection('content_header'); ?>
                ...
                <a type="button" class="btn-lg btn-success" style="margin: 10px" id="button-addon1" href="<?php echo e(url('fichaAnimal/create')); ?>"><i class="fas fa-recycle"></i></a>
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>  
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="<?php echo e(route('fichaAnimal.destroy',$i->id)); ?>"  class="d-inline  formulario-eliminar"  method="POST">
