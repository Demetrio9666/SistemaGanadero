...
"<?php echo e(url('/controlVacuna')); ?>"
<?php $__env->stopSection(); ?>
<?php $__env->startSection('boton_reporte_excel'); ?>
"<?php echo e(url('exportar-excel-controlVacunas-Inactivos')); ?>"
<?php $__env->stopSection(); ?>
<?php $__env->startSection('boton_reporte_pdf'); ?>
"<?php echo e(url('descarga-pdf-controlVacunas-Inactivos')); ?>"
<?php $__env->stopSection(); ?>
    ...
    <tbody>  
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-primary" href="<?php echo e(route('inactivos.controlVacunas.edit',$i->id)); ?>" ><i class="fas fa-edit"></i></a>
                <form action="<?php echo e(route('inactivos.controlVacunas.destroy',$i->id)); ?>"  class="d-inline  formulario-eliminar"  method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.baseTablasInactivas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/vaccineC/index-inactivo.blade.php ENDPATH**/ ?>