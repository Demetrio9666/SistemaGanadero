...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-md-6">
            ...
            <input type="decimal" class="form-control <?php echo e($errors->has('date') ? 'is-invalid':''); ?>" id="peso" name="weigtht" onChange="ValidarPeso(this.value)" value="<?php echo e(old('weigtht')); ?>" >
