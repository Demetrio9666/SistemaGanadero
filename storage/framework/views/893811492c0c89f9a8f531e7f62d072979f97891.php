...
<div class="form-group">
    ...
    <div class="form-group">
        <a type="submit" class="btn btn-secondary btn-lg" href="<?php echo e(url('/rol')); ?>">Cancelar</a>
        <button type="submit" class="btn btn-success btn-lg"  href="<?php echo e(Redirect::to('/rol')); ?>" >Guardar</button>
    </div>
</div>
