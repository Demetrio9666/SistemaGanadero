        ...
        <div class="frm">
            ...
            <form action="<?php echo e(route('inactivos.fichaReproduccionA.update', $re->id)); ?>" method="POST">
                ...
                <div class="form-group"  id="reproduccion_ar"   >
                    ...
                    <br>
                        <div class="input-group mb-3 ">
                                ...
                                <input type="hidden" id="idcodi_ar" name="artificial_id"    value="<?php echo e($re->artificial_id); ?>" disabled=disabled>
                                <div class="col-md-6">
                                        <label>Raza:</label>
                ...
                <div class="col-md-8-self-center" style="margin: 80px" >
                    <a type="submit" class="btn btn-secondary btn-lg"   href="<?php echo e(url('inactivos/fichaReproduccionA')); ?>">Cancelar</a>
                    <button type="submit" class="btn btn-success btn-lg"  style="margin: 10px" href="<?php echo e(Redirect::to('inactivos/fichaReproduccionA')); ?>" >Guardar</button>
                </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/file_reproductionA/edit-inactivo.blade.php ENDPATH**/ ?>