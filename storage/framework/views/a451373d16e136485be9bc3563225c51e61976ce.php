...
<form action="<?php echo e(route('inactivos.fichaReproduccionA.update', $re->id)); ?>" method="POST">
    ...
    <center>
        <div class="col-md-8-self-center" style="margin: 40px" >
            <a type="submit" class="btn btn-secondary btn"   href="<?php echo e(url('/inactivos/fichaReproduccionA')); ?>">Cancelar</a>
            <button type="submit" class="btn btn-success btn"  style="margin: 10px" href="<?php echo e(Redirect::to('/inactivos/fichaReproduccionA')); ?>" >Guardar</button>
        </div>
    </center>
