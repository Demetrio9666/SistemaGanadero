...
<head>
  ...
  <body>
    ...
    <a type="button" class="btn-lg btn-success" style="margin: 10px" id="button-addon1" href="<?php echo e(url('/confRaza')); ?>"><i class="fas fa-arrow-left"></i></a>
    <div class="card">
        <div class="card-body">
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/race/index-inactivo.blade.php ENDPATH**/ ?>