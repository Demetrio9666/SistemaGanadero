            ...
            <div class="frm">
                ...
                <form action=" <?php echo e(route('confAnt.update',$anti->id)); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="antibiotico_d" name="antibiotic_d" value="<?php echo e($anti->antibiotic_d); ?>" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="proveedor" name="supplier" value="<?php echo e($anti->supplier); ?>" >
                    </div>   
                    <div  class="form-group">
                    ...
                    <div class="form-group">
                        <a type="submit" class="btn btn-secondary btn-lg" href="<?php echo e(url('/confAnt')); ?>" >Cancelar</a>
                        <button type="submit" class="btn btn-success btn-lg"  href="<?php echo e(Redirect::to('/confAnt')); ?>" >Actualizar</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/antibiotic/edit-antibiotic.blade.php ENDPATH**/ ?>