            ...
            <div class="frm">
                ...
                <form action=" <?php echo e(route('fichaReproduccionEx.update',$ext->id)); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="raza" name="animalCode_Exte" value="<?php echo e($ext->animalCode_Exte); ?>" >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="razas"  name="sex" value="<?php echo e($ext->sex); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="hacienda_name" value="<?php echo e($ext->hacienda_name); ?>">
                    </div> 
                    <div  class="form-group">
                    ...
                    <div class="form-group">
                        <a type="submit" class="btn btn-secondary btn-lg" href="<?php echo e(url('/fichaReproduccionEx')); ?>" >Cancelar</a>
                        <button type="submit" class="btn btn-success btn-lg"  href="<?php echo e(Redirect::to('/fichaReproduccionEx')); ?>" >Actualizar</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/file_reproductionME/edit-external_M.blade.php ENDPATH**/ ?>