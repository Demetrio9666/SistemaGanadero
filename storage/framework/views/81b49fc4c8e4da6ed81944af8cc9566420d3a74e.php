        ...
        <div class="frm">
            ...
            <form action="<?php echo e(route('controlPeso.update',$pesoC->id)); ?>"   method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fecha_r" name="date" value="<?php echo e($pesoC->date); ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success btn-lg"  href="<?php echo e(Redirect::to('/controlPeso')); ?>" >Guardar</button>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/weigthC/edit-weigthC.blade.php ENDPATH**/ ?>