...
<head>
  ...
  <body>
    ...
    <a type="button" class="btn btn-success" style="margin: 10px" id="button-addon1" href="<?php echo e(url('confAnt/create')); ?>">Nuevo</a>
    <div class="card">
        <div class="card-body">
            ...
            <tbody>  
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="<?php echo e(route('confAnt.destroy',$i->id)); ?>" method="POST" class="d-inline  formulario-eliminar">
                            <?php echo csrf_field(); ?>
