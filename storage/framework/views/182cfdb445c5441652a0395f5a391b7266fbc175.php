                ...
                <div class="row">
                            ...
                            <center>
                                <div class="col-md-6" style="margin: 40px">
                                    <a type="submit" class="btn btn-secondary "   href="<?php echo e(url('/inactivos/fichaPartos')); ?>">Cancelar</a>
                                    <button type="submit" class="btn btn-success "  style="margin: 10px" href="<?php echo e(Redirect::to('/inactivos/fichaPartos')); ?>" >Guardar</button>
                                </div>
                            </center>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('file_partum.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/file_partum/edit-inactivo.blade.php ENDPATH**/ ?>