...
<head>
  ...
  <body>
    ...
    <a type="button" class="btn-lg btn-success" style="margin: 10px" id="button-addon1" href="<?php echo e(url('controlDesparasitacion/create')); ?>"><i class="fas fa-plus-square"></i></a>
    <a type="button" class="btn-lg btn-success" style="margin: 10px" id="button-addon1" href="<?php echo e(url('inactivos/controlDesparasitaciones')); ?>"><i class="fas fa-recycle"></i></a>
