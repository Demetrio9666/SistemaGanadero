            ...
            <div class="frm">
                ...
                <form action="<?php echo e(route('confAnt.store')); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success btn-lg"  href="<?php echo e(Redirect::to('/confAnt')); ?>" >Guardar</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/antibiotic/create-antibiotic.blade.php ENDPATH**/ ?>