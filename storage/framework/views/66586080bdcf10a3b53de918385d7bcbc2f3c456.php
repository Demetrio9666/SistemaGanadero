...
<form action=" <?php echo e(route('confVacuna.update',$vacuna->id)); ?>" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="vaccine_d" name="vaccine_d" value="<?php echo e($vacuna->vaccine_d); ?>" onblur="upperCase()">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="supplier" name="supplier" value="<?php echo e($vacuna->supplier); ?>" onblur="upperCase()">
    </div>  
    <div  class="form-group">
    ...
    <center>
        <div class="form-group" style="margin: 40px">
            ...
            <button type="submit" class="btn btn-success btn"  href="<?php echo e(Redirect::to('/confVacuna')); ?>" >Actualizar</button>
        </div>
    </center>  
...
<?php echo $__env->make('vaccine.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/vaccine/edit-vaccine.blade.php ENDPATH**/ ?>