...
<form action=" <?php echo e(route('confVi.update',$vitamina->id)); ?>" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="vitamina_d" name="vitamin_d" value="<?php echo e($vitamina->vitamin_d); ?>" onblur="upperCase()" >
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="supplier" name="supplier" value="<?php echo e($vitamina->supplier); ?>" onblur="upperCase()">
    </div>   
    <div  class="form-group">
    ...
    <center>
        <div class="form-group" style="margin: 40px">
            ...
            <button type="submit" class="btn btn-success btn"  href="<?php echo e(Redirect::to('/confVi')); ?>" >Actualizar</button>
        </div>
    </center>    
    <?php echo $__env->make('layouts.base-usuario', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('vitamin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/vitamin/edit-vitamin.blade.php ENDPATH**/ ?>