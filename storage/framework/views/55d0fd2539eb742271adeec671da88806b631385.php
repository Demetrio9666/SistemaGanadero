...
<body>
    ...
    <div class="card card-dark">
        ...
        <h3 class="card-title">
            ...
            Editar Registro de Animales Inactivos</h3>
        </div>
                ...
                <div class="frm">
                    <form action="<?php echo e(route('inactivos.fichaAnimales.update', $animal->id)); ?>" method="POST" class="row g-3">
                        ...
                        <div class="col-md-6-self-center" style="margin: 40px">
                                ...
                                <a type="submit" class="btn btn-secondary btn-lg"   href="<?php echo e(url('/inactivos/fichaAnimales')); ?>">Cancelar</a>
                                <button type="submit" class="btn btn-success btn-lg"  style="margin: 10px" href="<?php echo e(Redirect::to('/inactivos/fichaAnimales')); ?>" >Guardar</button>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/file_animale/edit-inactivo.blade.php ENDPATH**/ ?>