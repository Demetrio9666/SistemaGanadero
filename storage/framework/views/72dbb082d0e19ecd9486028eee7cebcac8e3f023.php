...
<head>
  ...
  <body>
    ...
    <a type="button" class="btn-lg btn-success float-right"  id="button-addon1" href="<?php echo e(url('exportar-excel-fichaTratamiento')); ?>"><i class="fas fa-file-excel"></i></a>
    <a type="button" class="btn-lg btn-danger float-right"  id="button-addon1" href="<?php echo e(url('descarga-pdf-fichaTratamiento')); ?>"><i class="fas fa-file-pdf"></i></a>
    <div class="card">
        <div class="card-body">
