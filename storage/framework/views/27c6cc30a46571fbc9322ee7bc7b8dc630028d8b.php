            ...
            <div class="frm">
                ...
                <form action="<?php echo e(route('confVi.store')); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success btn-lg"  href="<?php echo e(Redirect::to('/confVi')); ?>" >Guardar</button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/vitamin/create-vitamin.blade.php ENDPATH**/ ?>