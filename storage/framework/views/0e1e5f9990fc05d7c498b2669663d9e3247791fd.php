        ...
        <div class="frm">
            ...
            <form action="<?php echo e(route('fichaReproduccionM.update', $re->id)); ?>" method="POST">
                ...
                <div class="col-md-8-self-center" style="margin: 80px" >
                    <a type="submit" class="btn btn-secondary btn-lg"   href="<?php echo e(url('/fichaReproduccionM')); ?>">Cancelar</a>
                    <button type="submit" class="btn btn-success btn-lg"  style="margin: 10px" href="<?php echo e(Redirect::to('/fichaReproduccionM')); ?>" >Guardar</button>
                </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/file_reproductionM/edit-reproduction.blade.php ENDPATH**/ ?>