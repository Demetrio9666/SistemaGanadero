...
<form action="<?php echo e(route('confDespa.store')); ?>" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control <?php echo e($errors->has('dewormer_d') ? 'is-invalid':''); ?>" id="dewormer_d" name="dewormer_d" value="<?php echo e(old('dewormer_d')); ?>"  onblur="upperCase()">
        <?php $__errorArgs = ['dewormer_d'];
