...
<form action="<?php echo e(route('confRaza.store')); ?>" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control <?php echo e($errors->has('race_d') ? 'is-invalid':''); ?>" id="raza" name="race_d" value="<?php echo e(old('race_d')); ?>">
        <?php $__errorArgs = ['race_d'];
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-group">
        ...
        <input type="int" class="form-control <?php echo e($errors->has('percentage') ? 'is-invalid':''); ?>" id="porcentaje" name="percentage" value="<?php echo e(old('percentage')); ?>">
