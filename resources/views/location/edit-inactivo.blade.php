            ...
            <div class="frm">
                ...
                <form action=" {{route('inactivos.Ubicaciones.update',$ubicacion->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="porcentaje" name="description" value="{{$ubicacion->description}}" disabled=disabled>
                    </div>      
                    <div  class="form-group">
                    ...
                    <div class="form-group">
                        <a type="submit" class="btn btn-secondary btn-lg" href="{{url('/inactivos/Ubicaciones')}}" >Cancelar</a>
                        <button type="submit" class="btn btn-success btn-lg"  href="{{ Redirect::to('/inactivos/Ubicaciones') }}" >Actualizar</button>
                    </div>
                </form>
            </div>
        </div>
