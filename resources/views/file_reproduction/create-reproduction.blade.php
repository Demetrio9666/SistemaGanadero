            ...
            <form action="{{route('fichaReproduccion.store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="inputPassword4" name="estado" onChange="mostrar(this.value)">
                      <option  id="0" selected>seleccione</option>
                      <option id="Monta Interna" >Monta Interna</option>
                      <option id="Reproduccion Artificial">Artificial</option>
                </select>
                </div>

                <div class="form-group" style="display: none;" id="monta_interna">
                ...
                <div class="form-group" style="display: none;" id="reproduccion_ar">
