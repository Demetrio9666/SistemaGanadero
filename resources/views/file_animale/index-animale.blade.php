...
<head>
    ...
    @section('content_header')
                ...
                <a type="button" class="btn-lg btn-success float-right"  id="button-addon1" href="{{url('inactivos/fichaAnimales')}}"><i class="fas fa-file-excel"></i></a>
                <a type="button" class="btn-lg btn-danger float-right"  id="button-addon1" href="{{url('inactivos/fichaAnimales')}}"><i class="fas fa-file-pdf"></i></i></a>
                <a type="button" class="btn-lg btn-warning float-right"  id="button-addon1" href="{{url('inactivos/fichaAnimales')}}"><i class="fas fa-print"></i></a>
