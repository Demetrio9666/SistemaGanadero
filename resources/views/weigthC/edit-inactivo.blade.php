    ...
    <div class="container" id="registration-form">
        ...
        <div class="frm">
            ...
            <form action="{{route('inactivos.controlPesos.update',$pesoC->id)}}"   method="POST">
                ...
                <div class="form-group">
                    <a type="submit" class="btn btn-secondary btn-lg" href="{{url('inactivos/controlPesos')}}">Cancelar</a>
                    <button type="submit" class="btn btn-success btn-lg"  href="{{ Redirect::to('inactivos/controlPesos') }}" >Guardar</button>
                </div>
            </form>
        </div>
    </div>
